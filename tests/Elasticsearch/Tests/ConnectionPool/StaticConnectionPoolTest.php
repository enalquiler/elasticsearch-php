...
class StaticConnectionPoolTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAllExceptLastHostFailPingRevivesInSkip()
    {
        ...
        $goodConnection = m::mock('\Enalquiler\Elasticsearch\Connections\Connection')
    ...
    public function testCustomConnectionPoolIT() {
        $clientBuilder = \Enalquiler\Elasticsearch\ClientBuilder::create();
        $clientBuilder->setHosts(['localhost:1']);
        $client = $clientBuilder
            ->setRetries(0)
            ->setConnectionPool('\Enalquiler\Elasticsearch\ConnectionPool\StaticConnectionPool', [])
            ->build();
